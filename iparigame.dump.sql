...
--
-- Host: localhost    Database: iparigame
-- ------------------------------------------------------
...
CREATE TABLE `house` (
  ...
  `worth` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_house` (`ownerid`)
...
CREATE TABLE `user` (
  ...
  `role` varchar(1) COLLATE utf8_hungarian_ci NOT NULL,
  `dateofreg` date DEFAULT NULL,
  `fullname` varchar(150) COLLATE utf8_hungarian_ci DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'admin','admin',900000,'a','2011-04-06','Adminis Traitor','admin@admin.ad');
